...
[slide]
# Problem: Min and Max
[code-task title="Min and Max" taskId="p-03" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.util.Scanner;
...
[vimeo-video videoId="343678060" startTimeInSeconds="6247" endTimeInSeconds="8624" /]
